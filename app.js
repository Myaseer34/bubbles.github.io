...
ctx.fillText('BUBBLES', 55, 52); // Add values here to center
const textCoordinates = ctx.getImageData(0, 0, 300, 500);
...
function animate() {
    ...
    ctx.fillText('score: ' + score, 425, 415);
    ctx.fillStyle = 'rgba(34,147,214,1)';
    ctx.fillText('score: ' + score, 426, 415);
    gameFrame += 1;
